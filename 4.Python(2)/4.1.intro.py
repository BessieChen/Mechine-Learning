...
if __name__ == "__main__":
    ...
    # for j in np.logspace(0, 7, num = 8):#从0^0 - 0^7 一共八个
    #     print j
    ...
    # 5.绘图
    # 5.1 绘制正态分布概率密度函数
    # mpl.rcParams['font.sans-serif'] = [u'FangSong']  #FangSong/黑体 FangSong/KaiTi
    ...
    # t = np.arange(0, mx+1)
    # plt.plot(t, p.pmf(t), 'ro-', lw=2) #Probability mass function
    # plt.grid(True)
    #
    # N = 1000
    # M = 10000
